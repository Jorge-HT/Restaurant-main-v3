...
<html lang="en">
    ...
    <body>
        ...
        $menuItems = [
            ...
            ['name' => 'Sprite ($1.99)', 'description' => 'Large sized soda'], 
            ['name' => 'Barqs Root Beer ($1.99)', 'description' => 'Large sized soda'],
            ['name' => 'Diet Coke ($1.99)', 'description' => 'Large sized soda'],
            ['name' => 'Barqs Root Beer ($1.79)', 'description' => 'Medium sized soda'],
            ['name' => 'Dr. Pepper ($1.79)', 'description' => 'Medium sized soda'],
            ['name' => 'Sprite ($1.79)', 'description' => 'Medium sized soda'],
            ['name' => 'Coca Cola ($1.79)', 'description' => 'Medium sized soda'],
            ['name' => 'Diet Coke ($1.79)', 'description' => 'Medium sized soda'],
            ['name' => 'Barqs Root Beer ($1.39)', 'description' => 'Small sized soda'],
            ['name' => 'Dr. Pepper ($1.39)', 'description' => 'Small sized soda'],
            ['name' => 'Sprite ($1.39)', 'description' => 'Small sized soda'],
            ['name' => 'Coca Cola ($1.39)', 'description' => 'Small sized soda'],
            ['name' => 'Diet Coke ($1.39)', 'description' => 'Small sized soda'],
            ['name' => 'Apple Bites Dessert ($1.09)', 'description' => 'sugary apple flavored bite-sized donuts'],
            ['name' => 'Churros Dessert ($1.39)', 'description' => 'flour made dough fried and coated with cinnamon sugar'],
            ['name' => 'Ice Cream Cone Dessert ($2.45)', 'description' => 'one big scoop of flavored ice cream on a waffle cone'],
            ['name' => 'Chocolate Shake Dessert ($1.65)', 'description' => 'chocolate milkshake'],
        ];
